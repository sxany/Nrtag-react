...
const Lewatkan = () => {
    return (
        <div className='lewatkan relative mx-auto max-md:mt-[1000px]' style={{}}>
            {/*kotak*/}
            ...
            <div className='ml-12 md:flex relative md:space-x-2 max-md:mt-2'>
                <img src='./images/mumbai.jpg'className=' md:w-1/6 '></img>

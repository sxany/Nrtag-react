...
const Footer = () => {
    return (
        <footer className='mx-auto justify-items-center mt-5' style={{backgroundColor:'#2B2B2B',width:'1280px', height:'auto', margin:'' }}>
            <h1 style={{color:'#ffff', fontFamily: "Familjen Grotesk, serif", fontWeight: '500', fontStyle: 'normal', fontSize: '36px'}}>Nrtag Developer</h1>
